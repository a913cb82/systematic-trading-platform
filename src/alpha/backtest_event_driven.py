...
class EventDrivenBacktester:
    ...
    def run(self):
        ...
        bars = self.market_data.get_bars(universe, self.start_date, self.end_date)
    ...
    def _execute_trades(self, timestamp: datetime, target_weights: Dict[int, float], total_equity: float):
