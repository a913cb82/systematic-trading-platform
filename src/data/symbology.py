...
class SymbologyService:
    ...
    def map_to_internal_id(self, id_type: str, id_value: str, date: datetime, exchange: Optional[str] = None) -> Optional[int]:
        """
        ...
        if id_type.upper() == 'TICKER':
            ...
            return self.ism.get_internal_id_by_external(id_type.upper(), id_value, date)

    def get_all_identifiers(self, internal_id: int, date: datetime) -> Dict[str, Any]:
        """
