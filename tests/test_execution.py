...
class TestExecution(unittest.TestCase):
    def setUp(self):
        ...
        self.oms = OrderManagementSystem(self.publisher, self.engine, self.safety)
    ...
    def test_oms_execution_flow(self):
        ...
        bars = [
            {"internal_id": 1, "timestamp": timestamp, "close": 150.0, "open": 150.0, "high": 151.0, "low": 149.0, "volume": 10000.0}
        ]
