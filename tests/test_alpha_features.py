...
class TestFeatureStore(unittest.TestCase):
    ...
    def test_cycle_feature(self):
        ...
        for i in range(10):
            bars.append(Bar(
                ...
                timestamp_knowledge=datetime(2023, 1, 1) + timedelta(days=i),
                open=100.0 + i,
                high=101.0 + i,
                low=99.0 + i,
                close=100.5 + i,
        ...
        features = self.feature_store.calculate_cycle_feature([1], datetime(2023, 1, 1), datetime(2023, 1, 10), 'returns_1d')
    ...
    def test_event_feature(self):
        events = [
            Event(internal_id=1, type='EARNINGS', value={'surprise': 0.1}, timestamp_event=datetime(2023, 1, 15), timestamp_knowledge=datetime(2023, 1, 15)),
        ]
        self.event_store.write_events(events)
        
        features = self.feature_store.calculate_event_feature([1], datetime(2023, 1, 1), datetime(2023, 1, 31), 'earnings_surprise')
