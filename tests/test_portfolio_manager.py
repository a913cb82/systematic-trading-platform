...
class TestPortfolioManager(unittest.TestCase):
    def test_portfolio_manager_flow(self):
        ...
        try:
            ...
            bars = [
                {"internal_id": 1, "timestamp": timestamp, "close": 100.0, "open": 100.0, "high": 101.0, "low": 99.0, "volume": 1000.0},
                {"internal_id": 2, "timestamp": timestamp, "close": 200.0, "open": 200.0, "high": 202.0, "low": 198.0, "volume": 500.0}
            ]
            mde.write_bars(bars)
            ...
            self.assertAlmostEqual(sum(published_weights.values()), 1.0, places=5)
        finally:
